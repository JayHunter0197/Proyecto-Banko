		...
		<div class="row">
			...
			<div class="row mt-5">
				...
				<div class="col-md-12 d-flex justify-content-center text-dark">
					<s:form class="text-center border border-light p-5 text-light" action="movimientos">
						...
						<s:submit class="btn btn-info btn-block my-4" value="Consultar Movimientos"></s:submit>
